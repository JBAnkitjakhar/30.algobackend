...
//      */
//     @PostMapping("/approaches/init-status")
//     public ResponseEntity<Map<String, Object>> initializeApproachStatus() {
//         Map<String, Object> result = approachMigrationService.initializeStatus();
//         return ResponseEntity.ok(result);
//     }
// }